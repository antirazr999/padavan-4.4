...
mkdir -p -m 777 /tmp/dnsmasq.dom
mkdir -p -m 777 /tmp/adbyby
...
echo "4096 131072 67108864" > /proc/sys/net/ipv4/tcp_wmem
echo "4096 131072 67108864" > /proc/sys/net/ipv4/tcp_rmem
